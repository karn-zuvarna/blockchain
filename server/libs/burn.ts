...
export async function burn(_amount: string, network: NetworkName = parseNetwork()) {
  ...
  const data = encodeFunctionData({ abi, functionName: 'burnFrom', args: [tokenAddress, amount] })
